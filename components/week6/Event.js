    ...
    return (
        <View style={props.style}>
            ...
            <FlatList
                ...
                renderItem={
                    ({ item, index }) => {
                        ...
                        return (
                            <View style={{ marginRight : 10, backgroundColor:'white' , borderTopRightRadius : 10 , borderTopLeftRadius : 10 , borderBottomLeftRadius : 10 , borderBottomRightRadius : 10 }}>
            <Image style={{ width:320, height :150, borderRadius:10 }} source={{ uri : item.uri}} />
           
            <View style= {{flexDirection : 'row', borderBottomLeftRadius : 5 , borderBottomRightRadius : 5 ,  borderWidth : 5 , borderColor : 'white' }}>    
            ...
            <Text style={{ fontSize: 20, color : 'black ' , textAlign : 'center' }}>{ item.date }</Text>  
                ...
                <View style={{padding : 10}}>
            <Text style={{ fontSize: 20, color : ' red ' , fontWeight : 'bold' }}>{ item.title }</Text>  
            <Text style={{ fontSize: 16, color : 'black' }}>{ item.datetime }</Text> 
            <Text style={{ fontSize: 16, color : ' black ' }}>{ item.place }</Text> 
